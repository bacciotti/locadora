...
class SiteMoviesController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        return view('site.movies.index', compact('movies'));
    }
    ...
    {
        $genres = Genre::all();
        return view('site.movies.create', compact('genres'));
    }
    ...
    public function show($id)
    {
        ...
        return view('site.movies.show', compact('movie'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('site.movies.edit', compact('movie', 'genres'));

...
@section('content')
<a href="{{ url('/admin/media-types/create') }}" class="btn btn-success btn-sm" title="Adiconar Novo Tipo de Mídia"><i class="fa fa-plus" aria-hidden="true"></i> Adicionar Novo</a>

...
@section('content')
<a href="{{ url('/admin/movies/create') }}" class="btn btn-success btn-sm" title="Add New Movie"><i class="fa fa-plus" aria-hidden="true"></i> Adiconar Novo</a>
...
<div class="table-responsive">
    <table class="table">
        <thead>
            <tr>
                <th>ID</th><th>Título Original</th><th>Título Nacional</th><th>País</th><th>Ações</th>
            </tr>
        </thead>
        <tbody>
        @foreach($movies as $item)
            <tr>
                ...
                <td>
                    <a href="{{ url('/admin/movies/' . $item->id) }}" title="View Movie"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                    <a href="{{ url('/admin/movies/' . $item->id . '/edit') }}" title="Edit Movie"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>

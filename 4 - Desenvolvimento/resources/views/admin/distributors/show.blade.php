...
<a href="{{ url('/admin/distributors/' . $distributor->id . '/edit') }}" title="Editar Distributor"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>
        ...
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    ...
                    <tr><th> Corporate Name </th><td> {{ $distributor->corporate_name }} </td></tr><tr><th> Cnpj </th><td> {{ $distributor->cnpj }} </td></tr><tr><th> Address </th><td> {{ $distributor->address }} </td></tr>
                </tbody>
            </table>
        </div>
    </div>

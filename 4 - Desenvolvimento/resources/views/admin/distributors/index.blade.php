...
@section('content')
<a href="{{ url('/admin/distributors/create') }}" class="btn btn-success btn-sm" title="Adiconar Novo Distribuidor"><i class="fa fa-plus" aria-hidden="true"></i> Adicionar Novo</a>

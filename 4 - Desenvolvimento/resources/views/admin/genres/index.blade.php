...
@section('content')
<a href="{{ url('/admin/genres/create') }}" class="btn btn-success btn-sm" title="Add New Genre"><i class="fa fa-plus" aria-hidden="true"></i> Adiconar Novo</a>
    ...
    <table class="table">
        ...
        @foreach($genres as $item)
            <tr>
                ...
                <td>{{ $item->name }}</td>
                <td>
                    <a href="{{ url('/admin/genres/' . $item->id) }}" title="View Genre"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Ver</button></a>
                    <a href="{{ url('/admin/genres/' . $item->id . '/edit') }}" title="Edit Genre"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Editar</button></a>

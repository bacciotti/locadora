...
@section('content')
<div class="col-md-9">
    <a href="{{ url('/admin/movie') }}" title="Back" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left" aria-hidden="true"></i> Back</a>
    <a href="{{ url('/admin/movie/' . $movie->id . '/edit') }}" title="Edit Movie" class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>

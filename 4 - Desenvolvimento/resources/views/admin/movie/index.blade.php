...
<div class="col-md-9">
    ...
    <form method="GET" action="{{ url('/admin/movie') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
            ...
            @foreach($movie as $item)
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{ url('/admin/movie' . '/' . $item->id) }}" accept-charset="UTF-8" style="display:inline">
                            {{ method_field('DELETE') }}
                            {{ csrf_field() }}
